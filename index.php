...
<head>
    ...
    <style>
        ...
        .splash {
            text-align: center;
            color: white;
            background: url("back2.jpg") no-repeat fixed center bottom;
...
<body>
    ...
    <div class="container-fluid splash" id="splash">
        <div class="container">
            <img src="womensss.jpg" alt="Portrait of a Woman" class="profile-image"> 
            <h1>HELLO!</h1> 
            <h1 class="intro-text"><span class="lead" id="typed">I am AshlyMol Thomas</span></h1>
        ...
        <div class="container footer-container">
            <div class="row footer-row">
                <div class="col-xs-12 text-center">
                    <address>
                        <p>© 2024 AshlyMol Thomas. All rights reserved.</p>
                    </address>
                </div>
            </div>
        </div>
